...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Guess2.setStyleSheet(u"background-color: #101010; color: white;")
        ...
        self.Guess1.setStyleSheet(u"background-color: #101010; color: white;")
        ...
        self.Tries.setGeometry(QRect(180, 40, 471, 41))
        font1 = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.GameText.setText(QCoreApplication.translate("MainWindow", u"Walcome to mastemind, you have 10 to guess the code!", None))
